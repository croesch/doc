...
@test "should contain all folders of current directory after 'init' and no characters are entered" {
  _important_documents

  containsElement folder "${COMPREPLY[@]}"
}

@test "should contain all unambiguous subfolders of current directory after 'init' and no characters are entered" {
  _important_documents
...
@test "should not contain ambiguous subfolders of current directory after 'init' and no characters are entered" {
  _important_documents

  notContainsElement child "${COMPREPLY[@]}"
}

@test "should not contain any files of current directory after 'init' and no characters are entered" {
  _important_documents

  notContainsElement file-1 "${COMPREPLY[@]}"
  notContainsElement file-2 "${COMPREPLY[@]}"
