...
@test "should contain all folders of DOC_STORAGE_DIRECTORY when no characters are entered after directory add" {
...
@test "should contain all unambiguous folders of DOC_STORAGE_DIRECTORY when no characters are entered after directory add" {
  _important_documents
...
@test "should not contain all ambiguous folders of DOC_STORAGE_DIRECTORY when no characters are entered after directory add" {
  _important_documents
...
@test "should contain all elements with a* when 'a' is entered after directory add" {
  COMP_WORDS[3]='a'
  _important_documents
...
@test "should not contain all elements with a* when 'b' is entered after directory add" {
  COMP_WORDS[3]='b'
  _important_documents
