...
@test "should contain all folders of DOC_STORAGE_DIRECTORY when no characters are entered after view" {
...
@test "should contain all unambiguous folders of DOC_STORAGE_DIRECTORY when no characters are entered after view" {
  _important_documents
...
@test "should not contain all ambiguous folders of DOC_STORAGE_DIRECTORY when no characters are entered after view" {
  _important_documents
...
@test "should contain all elements with a* when 'a' is entered after view" {
  COMP_WORDS[2]='a'
  _important_documents
...
@test "should not contain all elements with a* when 'b' is entered after view" {
  COMP_WORDS[2]='b'
  _important_documents
